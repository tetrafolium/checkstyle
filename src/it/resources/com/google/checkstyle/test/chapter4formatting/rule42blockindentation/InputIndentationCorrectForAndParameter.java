...
class InputIndentationCorrectForAndParameter { //indent:0 exp:0
    ...
    void fooMethodWithIf() { //indent:2 exp:2
        ...
        for (Map.Entry<String, String> entry : new SecondForClassWithLongName1("Loo" //indent:4 exp:4
    ...
    class InnerClassFoo { //indent:2 exp:2
        ...
        void fooMethodWithIf() { //indent:4 exp:4
            ...
            for (Map.Entry<String, String> entry : new SecondForClassWithLongName1("Loo" //indent:6 exp:6
...
class SecondForClassWithLongName1 //indent:0 exp:0
    ...
    public SecondForClassWithLongName1(String string) { //indent:2 exp:2
