...
class InputIndentationCorrectWhileDoWhileAndParameter { //indent:0 exp:0
  ...
  private boolean conditionSixth(final boolean flag, //indent:2 exp:2
      final SecondWhileLongNam1 instance) { //indent:6 exp:6
    return false; //indent:4 exp:4
  } //indent:2 exp:2
...
class SecondWhileLongNam1 { //indent:0 exp:0
  ...
  public SecondWhileLongNam1(final String string) { //indent:2 exp:2

  } //indent:2 exp:2

  String getString(final FooWhileClass instance, final int integer) { //indent:2 exp:2
    return "String"; //indent:4 exp:4
  } //indent:2 exp:2

  int getInteger(final FooWhileClass instance, final String string) { //indent:2 exp:2
    return -1;   //indent:4 exp:4
  } //indent:2 exp:2

  boolean getBoolean(final FooWhileClass instance, final boolean flag) { //indent:2 exp:2
    return false; //indent:4 exp:4
  } //indent:2 exp:2
