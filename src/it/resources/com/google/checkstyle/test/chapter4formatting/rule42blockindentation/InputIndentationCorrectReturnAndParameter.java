...
class InputIndentationCorrectReturnAndParameter { //indent:0 exp:0
  ...
  boolean fooMethodWithIf() { //indent:2 exp:2
    ...
    return conditionSecond(10000000000.0, new //indent:4 exp:4
        ...
        SecondClassLongNam4("Looooooooooooooo" //indent:8 exp:8
        + "ooooooooooooong").getBoolean(new FooReturnClass(), false)) || //indent:8 exp:8
        conditionFifth(true, new SecondClassLongNam4(getString(2048, "Looo" //indent:8 exp:8
        ...
        SecondClassLongNam4(getString(100000, "Loooooong" //indent:8 exp:8
  ...
  private boolean conditionSixth(final boolean flag, //indent:2 exp:2
      final SecondClassLongNam4 instance) { //indent:6 exp:6
    return false; //indent:4 exp:4
  } //indent:2 exp:2
  ...
  class InnerClassFoo { //indent:2 exp:2
    ...
    boolean fooMethodWithIf() { //indent:4 exp:4
      return conditionFirst("Loooooooooooooooooong", new //indent:6 exp:6
          SecondClassLongNam4("Loooooooooooooooooog").//indent:10 exp:10
    ...
    boolean fooReturn() { //indent:4 exp:4
      return conditionSecond(10000000000.0, new //indent:6 exp:6
          ...
          SecondClassLongNam4("Looooooooooooooo" //indent:10 exp:10
            + "ooooooooooooong").getBoolean(new FooReturnClass(), false)) || //indent:12 exp:>=10
            conditionFifth(true, new SecondClassLongNam4(getString(2048, "Looo" //indent:12 exp:>=10
            ...
            new FooReturnClass(), true)) || conditionSixth(false, new //indent:12 exp:>=10
              SecondClassLongNam4(getString(100000, "Loooooong" //indent:14 exp:>=10
    ...
    FooReturnClass anonymousClass = new FooReturnClass() { //indent:4 exp:4
      ...
      boolean fooMethodWithIf(final String stringStringStringStringLooooongString, //indent:6 exp:6
        ...
        return conditionSecond(10000000000.0, new //indent:8 exp:8
            ...
            SecondClassLongNam4("Looooooooooooooo" //indent:12 exp:12
              + "ooooooooooooong").getBoolean(new FooReturnClass(), false)) || //indent:14 exp:>=12
              conditionFifth(true, new SecondClassLongNam4(getString(2048, "Lo" //indent:14 exp:>=12
              ...
              new FooReturnClass(), true)) || conditionSixth(false, new //indent:14 exp:>=12
                SecondClassLongNam4(getString(100000, "Loooooong" //indent:16 exp:>=12
...
class SecondClassLongNam4 { //indent:0 exp:0

  public SecondClassLongNam4(final String string) { //indent:2 exp:2

  } //indent:2 exp:2

  String getString(final FooReturnClass instance, final int integer) { //indent:2 exp:2
    return "String"; //indent:4 exp:4
  } //indent:2 exp:2

  int getInteger(final FooReturnClass instance, final String string) { //indent:2 exp:2
    return -1;   //indent:4 exp:4
  } //indent:2 exp:2

  boolean getBoolean(final FooReturnClass instance, final boolean flag) { //indent:2 exp:2
    return false; //indent:4 exp:4
  } //indent:2 exp:2

  SecondClassLongNam4 getInstance() { //indent:2 exp:2
    return new SecondClassLongNam4("VeryLoooooooooo" //indent:4 exp:4
