...
class InputIndentationCorrectForAndParameter { //indent:0 exp:0
    ...
    void fooMethodWithIf() { //indent:2 exp:2
        ...
        for (int i = new SecondForClassWithLongName("Loooooooooooooooooooo" //indent:4 exp:4
            + "oong").getInteger(new FooForClass(), //indent:8 exp:8
            getString(1000000000, "Loooooooooooooooong")); i < 10; i++) {
        }
        //indent:10 exp:>=8

        for (Map.Entry<String, String> entry : new SecondForClassWithLongName("Loo" //indent:4 exp:4
        ...
        for (String string : new SecondForClassWithLongName(getString(1024 //indent:4 exp:4
...
class SecondForClassWithLongName //indent:0 exp:0
        implements Iterable<String> { //indent:8 exp:>=4

    public SecondForClassWithLongName(String string) { //indent:2 exp:2
