...
public class InputParenPadLeftRightAndNoSpace
{
    ...
    class ParenPadSpaceRight {
        ...
        ParenPadSpaceRight(final int i) {
            super();
        }
...
enum MyEnum {
    ...
    public int something(final Object o) {
    ...
    private static String getterName(final Exception t) {
    ...
    Object stringReturnValue(final Object result) {
