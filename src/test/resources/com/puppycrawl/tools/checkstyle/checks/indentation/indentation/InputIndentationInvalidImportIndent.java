...
import java.util //indent:0 exp:0 .RandomAccess; import java.util.RandomAccess; //indent:2 exp:4 warn
import java.util.RandomAccess; //indent:1 exp:0 warn
import java.util //indent:0 exp:0 .RandomAccess; //indent:19 exp:>=8
