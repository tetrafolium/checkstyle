...
//correct
    ...
    public class B {
        public int create(final int i, final int j) [][] { //incorrect, 17:41
    ...
    public class D {
        public int[][]   [] create(final int i, final int j) { //incorrect, 29:26
            return new int  [ i + j ]    [ i + j ]               [ 0 ]; //incorrect 30:29,42,66
        }
    }

    public class E {
        public int create(final int i, final int j, final int   [][] k)[] [][] { //incorrect, 35:47,57
    ...
    public static class F {
        public static Integer [][][] create(final int i, final int j) { //incorrect, 42:31
            int[][] [] f = new int[   0][1    ][    2    ]; //incorrect, 43:21
            return new Integer[i + j][i + j][0];
        }
    }
    public class G {
        public List<String> [] [] [] create(final int i, final int j) { //incorrect, 48:29,32,35
    ...
    public class H {
        public List<Integer> create(final int i, final int j)     []      [][] { //incorrect, 62:55,63
            return null;
        }
    }
//incorrect 85:15
