...
class InputIndentationCorrectIfAndParameter { //indent:0 exp:0
  ...
  private boolean co(final boolean flag, //indent:2 exp:2
      final SecondClassLongNam7 instance) { //indent:6 exp:6
    return false; //indent:4 exp:4
  } //indent:2 exp:2
...
class SecondClassLongNam7 { //indent:0 exp:0
  ...
  public SecondClassLongNam7(final String string) { //indent:2 exp:2

  } //indent:2 exp:2

  String getString(final InputIndentationCorrectIfAndParameter instance, final int integer) { //indent:2 exp:2
    return "String"; //indent:4 exp:4
  } //indent:2 exp:2

  int getInteger(final InputIndentationCorrectIfAndParameter instance, final String string) { //indent:2 exp:2
    return -1;   //indent:4 exp:4
  } //indent:2 exp:2

  boolean gB(final InputIndentationCorrectIfAndParameter instance, final boolean flag) { //indent:2 exp:2
    return false; //indent:4 exp:4
  } //indent:2 exp:2
